...
//       topics: [
//         { topic: 'ride-requests', numPartitions: 3, replicationFactor: 1 },
//         { topic: 'ride-assignments', numPartitions: 2, replicationFactor: 1 }
//       ],
//     });
//     console.log(`Topics created: ${created ? 'ride-requests, ride-assignments' : 'No new topics created'}`);
//   } catch (error) {
